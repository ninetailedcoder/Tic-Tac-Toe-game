...
class TicTacToe:
    def __init__(self):
        self.board = [' ' for _ in range(9)] # this represenst the 3x3 board
    ...
    def winner (self, square, letter):
        ...
        #these are the only moves possive to win a diagonal
...
def play(game, x_player, o_payer, print_game = True):
